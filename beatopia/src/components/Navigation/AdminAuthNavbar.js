...
const AdminAuthNavbar = () => {
    ...
    const goToContribute = () => navigate('/contribute')
  ...
  return (
    <div className='navbar-container'>
        ...
        <div className='navbar-links'>
            <button className='navbar-button' onClick={goToContribute} title='Contribute'>Contribute</button>
